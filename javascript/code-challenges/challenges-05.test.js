...
const addValues = (arr) => {
  // Solution code here...
  const adding = arr.reduce((acc, val) => {
    acc = acc + val
    return acc
  }, 0)
...
const addPurchases = (arr) => {
  // Solution code here...
  const totalPurchased = arr.reduce((acc, val) => {
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  const reduced = arr.reduce((acc, val, indx) => {
    acc = indx + 1
    return acc
  })
  return reduced
...
const returnNames = (arr) => {
  // Solution code here...
  // i dont know cuz the reduce return only key and value 
  let allnames = [];
